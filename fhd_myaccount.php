...
<h4><i class="fa fa-user"></i> Mi cuenta <small>(<?php echo $user_id;?>)</small></h4>

<form action="fhd_myaccount.php" method="post" class="form-horizontal" role="form">
<div class="form-group">
	<label for="user_login" class="col-sm-2 control-label">Nombre de usuario</label>
    <div class="col-sm-2">
...
<div class="form-group">
	<label for="user_password" class="col-sm-2 control-label">Clave</label>
    <div class="col-sm-3">
	<input type="text" class="form-control" name="user_password" id="user_password" value="" placeholder="minimo 5 caracteres">
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="checkbox">
    <label>
      <input type="checkbox" name="user_msg_send" value="1" <?php if($user_msg_send == 1){echo " CHECKED";}?>>Recibio email del estado de la consulta?
    </label>
	</div>
	</div>
</div>
...
<div class="form-group">
	<label for="user_phone" class="col-sm-2 control-label">Telefono</label>
    <div class="col-sm-2">
...
<div class="form-group">
	<label for="user_address" class="col-sm-2 control-label">Direccion</label>
    <div class="col-sm-3">
...
<div class="form-group">
	<label for="user_city" class="col-sm-2 control-label">Ciudad</label>
    <div class="col-sm-2">
