...
echo '<h4>Autenticación con contraseña de un solo uso</h4>';
...
if ($encrypted_passwords == "yes") {
	echo "<p class='text-danger'><strong>Esta función ya fue ejecutada!</strong></p>";
	include("includes/footer.php");
	exit;
}
?>

<h4><strong>Porfavor <u>Respaldar la Base de Datos</u> antes de comenzar.</strong></h4>
