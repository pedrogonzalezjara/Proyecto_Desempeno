...
<body>
    <h4><i class='fa fa-tag'></i> Llamar a Ejecutivo</h4>
...
<table class="<?php echo $table_style_3;?>" style='width: auto;'>
	...
	<td>Uno de nuestros ejecutivos establecerá comunación con usted si está disponible</td>
	</tr>		
			
	
</table>
    <input type="hidden" name="search" value="1">
            <input type="submit" value="Llamar" class="btn btn-primary">
