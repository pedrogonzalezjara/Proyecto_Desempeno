...
?>
<h4><i class='fa fa-tag'></i> Detalle de Consulta [ #<?php echo $call_id;?> ]</h4>

<?php if($user_level <> 1){ ?>
<p><i class="glyphicon glyphicon-edit"></i> <a href="fhd_call_edit.php?call_id=<?php echo $call_id;?>">Editar consulta</a></p>
<?php } ?>
...
<?php
	...
	echo "<tr><td>Nombre</td><td>" . $site_calls->call_first_name . "</td></tr>\n";
	echo "<tr><td>Email</td><td>".$site_calls->call_email."</td></tr>\n";
	echo "<tr><td>Departamento</td><td>$department_name</td></tr>\n";
...
<h5><i class="fa fa-plus"></i> <a href="fhd_add_note.php?call_id=<?php echo $call_id;?>&action=add&nacl=<?php echo $nacl;?>">añadir nota</a></h5>
...
if ($isnotes > 0){
	...
	echo "<tr><th>User</th><th>contenidos</th><th>Date</th></tr>";
